...
func (ue *GNBUe) CreateUeContext(plmn string, imeisv string, sst []string, sd []string, ueSecurityCapabilities *ies.UESecurityCapabilities) {
...
func (ue *GNBUe) GetUESecurityCapabilities() *ies.UESecurityCapabilities {
